...
the [{UpSetR} package](https://github.com/hms-dbmi/UpSetR) is very useful here--it 
can be used to generate distinctive graphs for set-related data. [^fn_upsetr] 
...
# session::save.session(file = file.path("data", "colors-eda-1.RData"))
```
